            ...
            <div class="row text-center justify-content-md-center">
                ...
                <div class="col-12 col-sm-8 col-xxl-4 p-0 m-0">
                    ...
                    <div class="position-relative">
                        <img src="{{ asset('img/home/banner-financiamiento01.jpg') }}" alt=""
                ...
                <div class="col-12 col-sm-4 col-xxl-8">
                    <div class="row">
                        <div class="col-12 col-xxl-6 p-0 m-0">
                            ...
                            <div class="position-relative">
                                <img src="{{ asset('img/home/banner-financiamiento02.jpg') }}" alt=""
                                    class="img-fluid rounded-top" loading="lazy">
                        ...
                        <div class="col-12 pb-0 mb-0 col-xxl-6 p-0 m-0">
                            ...
                            <div class="position-relative">
                                <img src="{{ asset('img/home/banner-financiamiento03.jpg') }}" alt=""
